...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Salão de beleza em Bragança Paulista. Agende cabelo e unhas online com nossas cabeleireiras e manicures." },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Vem Cá Menina — Salão de Beleza em Bragança Paulista" },
      { name: "twitter:title", content: "Vem Cá Menina — Salão de Beleza em Bragança Paulista" },
      { property: "og:description", content: "Salão de beleza em Bragança Paulista. Agende cabelo e unhas online." },
      { name: "twitter:description", content: "Salão de beleza em Bragança Paulista. Agende cabelo e unhas online." },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/a33ba207-8ffe-4d82-91a3-3c754457c367/logo-vem-ca-menina.png" },
